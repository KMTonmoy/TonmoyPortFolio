...
const SkillsPage = () => {
  ...
  const handleAddSkill = async () => {
    ...
    try {
      await axios.post("https://tonmoy-pro-backend.vercel.app/skills", newSkill);
  ...
  const handleUpdateSkill = async () => {
    ...
    try {
      await axios.patch(`https://tonmoy-pro-backend.vercel.app/skills/${editingSkill._id}`, editingSkill);
  ...
  const handleDeleteSkill = async (id: string) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://tonmoy-pro-backend.vercel.app/skills/${id}`);
        fetchSkills();
